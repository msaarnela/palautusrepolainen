...
Jokainen osallistuja kirjoittaa lapuille tekemiään huomioita tiimistä tai edellisestä sprintistä, yksi asia per lappu. Laput kiinnitetään esim. muistitaululle, joka on jaettu kolmeen sarakkeeseen: positiiviset huomiot (glad), negatiiviset huomiot (sad) ja tiimin toimintaa vaikeuttaneet (ulkopuoliset) asiat (mad). Jokainen saa äänestää, mistä asioista toivoo keskustelua. Palaverin kesto pitäisi olla enintään tunti.
